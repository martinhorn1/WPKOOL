...
<div class="ocdi  wrap  about-wrap">
	...
	<div class="ocdi__intro-text">
		...
		<ul>
			...
			<li><?php esc_html_e( 'Demo posts, pages, images, widgets, menus and other theme settings will get imported and installed.', 'hootkit' ); ?></li>
			<li><?php esc_html_e( 'It is recommended to install demo content on a fresh new site - otherwise images in the imported content may get shuffled (This is due to how WordPress stores media data)', 'hootkit' ); ?></li>
		</ul>
	...
	echo wp_kses_post( apply_filters( 'hkocdi/plugin_intro_text', $plugin_intro_text ) );
	?>
	...
	<?php elseif ( 1 === count( $predefined_themes ) ) : ?>
		...
		<div class="ocdi__hk-noticebox warningbox"><?php printf( esc_html( 'Please click on the Install button only once and wait.%1$sIt may take a couple of minutes depending upon the size of the content.', 'hootkit' ), '<br />'); ?></div>
	...
	<p class="ocdi__ajax-loader  js-ocdi-ajax-loader">
		<span class="spinner"></span> <?php printf( esc_html( 'Installing, please wait!%1$sThis may take a few minutes.%1$sDo not navigate away from this page while the content is being installed.', 'hootkit' ), '<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' ); ?>
	</p>
