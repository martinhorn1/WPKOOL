...
if ( ! function_exists( 'digital_services_get_font_choices' ) ) :
/**
 ...
 */
function digital_services_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'digital-services' ) ) ) );
	$standard_fonts = digital_services_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'digital-services' ) ) ) );
	$google_fonts   = digital_services_get_google_fonts();
	 ...
	 */
	return apply_filters( 'digital_services_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $google_fonts ) );
}
endif;
 ...
 * @return array    The fonts in value/label pairs.
 */
function digital_services_get_font_choices() {
	$fonts   = digital_services_get_all_fonts();
	$choices = array();
...
if ( ! function_exists( 'digital_services_get_google_font_uri' ) ) :
/**
 ...
 */
function digital_services_get_google_font_uri( $fonts ) {

	// De-dupe the fonts
	$fonts         = array_unique( $fonts );
	$allowed_fonts = digital_services_get_google_fonts();
	$family        = array();
	...
	foreach ( $fonts as $font ) {
		...
		if ( array_key_exists( $font, $allowed_fonts ) ) {
			...
			$family[] = urlencode( $font . ':' . join( ',', digital_services_choose_google_font_variants( $font, $allowed_fonts[ $font ]['variants'] ) ) );
		}
	}
	...
	$subset = get_theme_mod( 'font-subset', digital_services_get_default( 'font-subset' ) );

	if ( 'all' === $subset ) {
		$subsets_available = digital_services_get_google_font_subsets();
...
if ( ! function_exists( 'digital_services_get_google_font_subsets' ) ) :
/**
 ...
 */
function digital_services_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'digital-services' ),
		'cyrillic'     => __( 'Cyrillic', 'digital-services' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'digital-services' ),
		'devanagari'   => __( 'Devanagari', 'digital-services' ),
		'greek'        => __( 'Greek', 'digital-services' ),
		'greek-ext'    => __( 'Greek Extended', 'digital-services' ),
		'khmer'        => __( 'Khmer', 'digital-services' ),
		'latin'        => __( 'Latin', 'digital-services' ),
		'latin-ext'    => __( 'Latin Extended', 'digital-services' ),
		'vietnamese'   => __( 'Vietnamese', 'digital-services' ),
	);
}
endif;

if ( ! function_exists( 'digital_services_choose_google_font_variants' ) ) :
/**
 ...
 */
function digital_services_choose_google_font_variants( $font, $variants = array() ) {
	$chosen_variants = array();
	if ( empty( $variants ) ) {
		$fonts = digital_services_get_google_fonts();
	...
	return apply_filters( 'digital_services_font_variants', array_unique( $chosen_variants ), $font, $variants );
}
endif;

if ( ! function_exists( 'digital_services_get_standard_fonts' ) ) :
/**
 ...
 */
function digital_services_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'digital-services' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'digital-services' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'digital-services' ),
...
if ( ! function_exists( 'digital_services_get_font_stack' ) ) :
/**
 ...
 */
function digital_services_get_font_stack( $font ) {

	$all_fonts = digital_services_get_all_fonts();

	// Sanitize font choice
	$font = digital_services_sanitize_font_choice( $font );
...
if ( ! function_exists( 'digital_services_sanitize_font_choice' ) ) :
/**
 ...
 */
function digital_services_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
		// The array key is an integer, so the chosen option is a heading, not a real choice
		return '';
	} else if ( array_key_exists( $value, digital_services_get_font_choices() ) ) {
		return $value;
	} else {
		return '';
	}
...
if ( ! function_exists( 'digital_services_get_google_fonts' ) ) :
/**
 ...
 */
function digital_services_get_google_fonts() {
	return apply_filters( 'digital_services_get_google_fonts', array(
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
				'regular',
