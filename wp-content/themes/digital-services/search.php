        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title">
                    <h2><?php echo esc_html__('Search results for : ', 'digital-services') . get_search_query(); ?></h2>
                </div>
                ...
                <div class="blog-main">
                    ...
                    <?php if ( have_posts() ) :
                     while ( have_posts() ) : the_post(); ?>
                        ...
                        <?php else : 
                             esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'digital-services');
